...
function Index() {
  return (
    <main
      ...
      style={{
        background: "radial-gradient(ellipse at center, oklch(0.22 0.06 230) 0%, oklch(0.12 0.04 240) 70%)",
      }}
    >
      {/* Stars */}
      <div
      ...
      <div className="relative z-10 flex max-w-2xl flex-col items-center gap-8">
        ...
        <h1
          ...
          style={{
            textShadow: "0 0 10px oklch(0.85 0.18 200 / 0.8), 0 0 30px oklch(0.75 0.22 210 / 0.6)",
          }}
        >
          Site em Construção
        </h1>
